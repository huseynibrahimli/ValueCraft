...
class Private(object):
    ...
    def import_data(self, company_statement, company_code, session_id):
        ...
        df_is.to_html("templates/temp/IS_private_" + company_code + session_id + ".html",
        ...
        df_cf.to_html("templates/temp/CF_private_" + company_code + session_id + ".html",
                      float_format=lambda x: "{:,.0f}".format(x), classes="dataframe_statement")
    ...
    def project_fcf(self, company_statement, revenue_g, company_code, session_id):
        ...
        cf_forecast.to_html("templates/temp/FCF_private_" + company_code + session_id + ".html",
                            float_format=lambda x: "{:,.0f}".format(x), classes="dataframe_statement")
